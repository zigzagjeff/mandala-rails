...
class MandalaMcp::XmlTest < ActiveSupport::TestCase
  ...
  test "tile escapes markup in text and attributes" do
    xml = MandalaMcp::Xml.tile({ "id" => 1, "position" => 0,
  ...
  test "grid nests its tiles" do
    xml = MandalaMcp::Xml.grid({ "id" => 15, "chart_id" => 2, "depth" => 0,
